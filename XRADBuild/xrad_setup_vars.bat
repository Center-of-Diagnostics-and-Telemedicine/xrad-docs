...
@if NOT DEFINED QTDIR5x86 set _QTDIR5x86=C:\Qt\Qt5.6.0x86\5.6\msvc2015
@set _QTDIR5x64=%QTDIR5x64%
@if NOT DEFINED QTDIR5x64 set _QTDIR5x64=C:\Qt\Qt5.6.0\5.6\msvc2015_64
@set _QWTDIR5x86=%QWTDIR5x86%
@if NOT DEFINED QWTDIR5x86 @set _QWTDIR5x86=C:\Qwt\Qwt-6.1.2-x86
@set _QWTDIR5x64=%QWTDIR5x64%
@if NOT DEFINED QWTDIR5x64 set _QWTDIR5x64=C:\Qwt\Qwt-6.1.2-x64
